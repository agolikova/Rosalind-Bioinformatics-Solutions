...
#Each edge of adjacency list of T will be encoded by a triple containing integer representing edge's parent node followed by integer representing edge's child node, and finally symbol labeling edge
...
with open('../Files/rosalind_bio_TRIE2.txt', 'r') as myfile:
